                    ...
                    <div className="w-full max-w-md">
                        <div className={`relative flex items-center transition-all duration-200 ${isFocused ? 'ring-2 ring-blue-500/30' : ''} bg-gray-700/50 rounded-xl p-1 border border-gray-600`}>
                            ...
                            <button 
                                ...
                                className={`flex items-center cursor-pointer justify-center p-3 rounded-lg transition-all duration-200 ${joinCodeInput.trim() && !isLoading ? 'bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600' : 'bg-gray-600 cursor-not-allowed'} text-white`}
                ...
                <>
                    ...
                    <div className="buttonDiv">
                        <button 
                            ...
                            disabled={isLoading}
                            className='bg-gradient-to-r cursor-pointer from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed'
                        >
                    ...
                    {localRoomCode && (
                        <div className="showCode flex items-center gap-3 mt-2 w-full max-w-xs">
                            ...
                            <button 
                                onClick={handleCopy}
                                disabled={isLoading}
                                className='bg-gray-700/50 cursor-pointer hover:bg-gray-600/70 text-white p-3 rounded-lg border border-gray-600 transition-colors duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed'
