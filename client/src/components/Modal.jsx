  ...
  return (
    <>
      ...
      <div class="flex items-start gap-2.5">
        <img class="w-8 h-8 rounded-full" src="https://www.tarapadagarai.site/assets/TARAPADA-DQQzy6pt.jpeg" alt="Bonnie Green image" />
        ...
        <div class="flex flex-col gap-1">
          <div class="flex flex-col w-full max-w-[326px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
            ...
            <div class="group relative my-2.5">
              ...
              <img src="https://www.tarapadagarai.site/assets/TARAPADA-DQQzy6pt.jpeg" class="rounded-lg" />
            </div>
          </div>
        </div>
      </div>
